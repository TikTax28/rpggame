public static class World
{
    ...
    public static void PopulateQuests()
    {
        ...
        clearAlchemistGarden.QuestCompletionItems.Add(new QuestItem(ItemByID(ITEM_ID_RAT_TAIL), 3));
        ...
        clearFarmersField.QuestCompletionItems.Add(new QuestItem(ItemByID(ITEM_ID_SNAKE_FANG), 3));
        ...
        clearSpidersForest.QuestCompletionItems.Add(new QuestItem(ItemByID(ITEM_ID_SPIDER_SILK), 3));
